...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/hardware_system_2/arm_control_system/arm_control_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_control_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arm_control_system.tcl -notrace
