...
HD_PWD='/home/cmcnally/Repos/robotic_arm_control_system_analysis/vivado/lidar_arm_control/bare_metal_system/bare_metal_system.runs/lidar_arm_control_axi_timer_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lidar_arm_control_axi_timer_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lidar_arm_control_axi_timer_2_0.tcl
