...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm axi_lite_ipif_v3_0_4 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 lib_cdc_v1_0_2 axi_uartlite_v2_0_22 axi_infrastructure_v1_1_0 axi_vip_v1_1_4 processing_system7_vip_v1_0_6 generic_baseblocks_v2_1_0 axi_register_slice_v2_1_18 fifo_generator_v13_2_3 axi_data_fifo_v2_1_17 axi_crossbar_v2_1_19 proc_sys_reset_v5_0_13 axi_protocol_converter_v2_1_18)
...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.lidar_arm_control \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/70cf/hdl" \
       +incdir+"../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/ec67/hdl" \
       +incdir+"../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/70cf/hdl" \
       +incdir+"../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ip/lidar_arm_control_processing_system7_0_0" \
