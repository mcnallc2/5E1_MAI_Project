...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/us_arm_control/bare_metal_system/us_arm_control_system/us_arm_control_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log us_arm_module_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source us_arm_module_wrapper.tcl -notrace
