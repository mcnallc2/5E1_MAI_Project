...
#
# Generated by Vivado on Mon Apr 12 18:14:55 IST 2021
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb lidar_arm_control.wdb xsim.dir)
