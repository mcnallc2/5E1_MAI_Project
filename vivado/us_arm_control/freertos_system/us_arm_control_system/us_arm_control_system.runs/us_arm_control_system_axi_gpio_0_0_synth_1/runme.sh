...
EAStep vivado -log us_arm_control_system_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source us_arm_control_system_axi_gpio_0_0.tcl
