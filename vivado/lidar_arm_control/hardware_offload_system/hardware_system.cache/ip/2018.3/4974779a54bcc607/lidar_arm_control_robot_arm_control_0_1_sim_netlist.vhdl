...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lidar_packet_parser is
  port (
    \angle_ff_reg[7]_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lidar_packet_parser is
  ...
  signal interrupt_INST_0_i_22_n_0 : STD_LOGIC;
  signal interrupt_INST_0_i_23_n_0 : STD_LOGIC;
  signal interrupt_INST_0_i_24_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of interrupt_INST_0_i_12 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_14 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_15 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_16 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_18 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_19 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_21 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_22 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_23 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_24 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_6 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_7 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_8 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of interrupt_INST_0_i_9 : label is "soft_lutpair5";
begin
...
interrupt_INST_0_i_14: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1F"
    )
        port map (
...
interrupt_INST_0_i_16: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
interrupt_INST_0_i_18: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
interrupt_INST_0_i_2: unisim.vcomponents.LUT4
    generic map(
      ...
      I3 => interrupt_INST_0_i_9_n_0,
      O => interrupt_INST_0_i_2_n_0
    );
interrupt_INST_0_i_20: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
interrupt_INST_0_i_22: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
      ...
      O => interrupt_INST_0_i_22_n_0
    );
interrupt_INST_0_i_23: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
interrupt_INST_0_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => interrupt_INST_0_i_12_n_0,
      I3 => interrupt_INST_0_i_13_n_0,
...
interrupt_INST_0_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
        ...
        port map (
      I0 => interrupt_INST_0_i_16_n_0,
      I1 => interrupt_INST_0_i_17_n_0,
      I2 => interrupt_INST_0_i_18_n_0,
      I3 => interrupt_INST_0_i_19_n_0,
...
interrupt_INST_0_i_5: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => interrupt_INST_0_i_10_n_0,
      I1 => interrupt_INST_0_i_11_n_0,
      I2 => interrupt_INST_0_i_22_n_0,
      I3 => interrupt_INST_0_i_13_n_0,
      I4 => interrupt_INST_0_i_23_n_0,
      I5 => interrupt_INST_0_i_24_n_0,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_test_proc is
  port (
    ...
    PWM_CLK : in STD_LOGIC;
    \pwm_hightime_base_ff_reg[3]_i_2_0\ : in STD_LOGIC;
...
\pwm_hightime_base_ff[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^q\(0),
      I1 => \delay_ff[10]_i_3_n_0\,
      I2 => \pwm_hightime_base_ff_reg[3]_i_2_0\,
...
pwm_hightime_base_nxt0_carry_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"01FE"
        ...
        port map (
      I0 => \pwm_hightime_base_ff_reg[3]_i_2_0\,
      I1 => \^q\(0),
      I2 => \delay_ff[10]_i_3_n_0\,
      I3 => \^q\(1),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_robot_arm_control_v1_0_S00_AXI is
  ...
  signal \^angle_ff_reg[7]\ : STD_LOGIC;
...
lidar_packet_parser_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lidar_packet_parser
     port map (
      PWM_CLK => PWM_CLK,
      \angle_ff_reg[7]_0\ => \^angle_ff_reg[7]\,
...
test_proc_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_test_proc
     port map (
      ...
      \pwm_hightime_base_ff_reg[3]_i_2_0\ => \^angle_ff_reg[7]\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
