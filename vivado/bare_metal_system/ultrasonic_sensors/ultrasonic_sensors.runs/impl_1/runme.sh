...
HD_PWD='/home/cmcnally/Repos/mai_project/Vivado/ultrasonic_sensors/ultrasonic_sensors.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic_unit_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ultrasonic_unit_wrapper.tcl -notrace
