...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/hardware_offload_system_2/hardware_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lidar_arm_control_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lidar_arm_control_wrapper.tcl -notrace
