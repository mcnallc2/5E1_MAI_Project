...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/freertos_system/freertos_system.runs/lidar_arm_control_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
