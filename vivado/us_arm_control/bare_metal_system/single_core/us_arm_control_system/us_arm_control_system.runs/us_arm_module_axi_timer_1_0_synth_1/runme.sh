...
HD_PWD='/home/cmcnally/Repos/robotic_arm_control_system_analysis/vivado/SW_based_control/us_arm_control_system/us_arm_control_system.runs/us_arm_module_axi_timer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log us_arm_module_axi_timer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source us_arm_module_axi_timer_1_0.tcl
