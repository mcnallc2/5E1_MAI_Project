...
-- Date        : Wed Mar  3 18:02:54 2021
-- Host        : noodle-box running 64-bit Ubuntu 18.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/hardware_system/hardware_system.srcs/sources_1/bd/lidar_arm_control/ip/lidar_arm_control_robot_arm_control_0_1/lidar_arm_control_robot_arm_control_0_1_sim_netlist.vhdl
...
\PWM01_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \PWM01_carry__1_i_1_n_0\,
      DI(1) => \PWM01_carry__1_i_2_n_0\,
      DI(0) => \PWM01_carry__1_i_3_n_0\,
      O(3 downto 0) => \NLW_PWM01_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \PWM01_carry__1_i_4_n_0\,
      S(2) => \PWM01_carry__1_i_5_n_0\,
      S(1) => \PWM01_carry__1_i_6_n_0\,
      S(0) => \PWM01_carry__1_i_7_n_0\
    );
...
\PWM11_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \PWM11_carry__1_i_1_n_0\,
      DI(1) => \PWM11_carry__1_i_2_n_0\,
      DI(0) => \PWM11_carry__1_i_3_n_0\,
      O(3 downto 0) => \NLW_PWM11_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \PWM11_carry__1_i_4_n_0\,
      S(2) => \PWM11_carry__1_i_5_n_0\,
      S(1) => \PWM11_carry__1_i_6_n_0\,
      S(0) => \PWM11_carry__1_i_7_n_0\
    );
\PWM11_carry__1_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\PWM11_carry__1_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
\PWM21_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \PWM21_carry__1_i_1_n_0\,
      DI(1) => \PWM21_carry__1_i_2_n_0\,
      DI(0) => \PWM21_carry__1_i_3_n_0\,
      O(3 downto 0) => \NLW_PWM21_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \PWM21_carry__1_i_4_n_0\,
      S(2) => \PWM21_carry__1_i_5_n_0\,
      S(1) => \PWM21_carry__1_i_6_n_0\,
      S(0) => \PWM21_carry__1_i_7_n_0\
    );
\PWM21_carry__1_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\PWM21_carry__1_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
\PWM31_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \PWM31_carry__1_i_1_n_0\,
      DI(1) => \PWM31_carry__1_i_2_n_0\,
      DI(0) => \PWM31_carry__1_i_3_n_0\,
      O(3 downto 0) => \NLW_PWM31_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \PWM31_carry__1_i_4_n_0\,
      S(2) => \PWM31_carry__1_i_5_n_0\,
      S(1) => \PWM31_carry__1_i_6_n_0\,
      S(0) => \PWM31_carry__1_i_7_n_0\
    );
\PWM31_carry__1_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\PWM31_carry__1_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
