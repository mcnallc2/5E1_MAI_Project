...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/hardware_system_2/arm_control_system/arm_control_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_control_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_control_system.tcl
