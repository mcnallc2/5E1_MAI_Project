...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/ip_repo/edit_robot_arm_control_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log robot_arm_control_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source robot_arm_control_v1_0.tcl -notrace
