...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ip/lidar_arm_control_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ip/lidar_arm_control_xbar_2/sim/lidar_arm_control_xbar_2.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ip/lidar_arm_control_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../hardware_system.srcs/sources_1/bd/lidar_arm_control/ip/lidar_arm_control_auto_pc_1/sim/lidar_arm_control_auto_pc_1.v" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/hardware_offload_system_2/hardware_system.cache/compile_simlib/vcs"
  fi
