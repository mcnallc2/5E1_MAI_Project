...
HD_PWD='/home/cmcnally/Repos/mai_project/Vivado/ultrasonic_sensors/ultrasonic_sensors.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic_unit_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultrasonic_unit_wrapper.tcl
