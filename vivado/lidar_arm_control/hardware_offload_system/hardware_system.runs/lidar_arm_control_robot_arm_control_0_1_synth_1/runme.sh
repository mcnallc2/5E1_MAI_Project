...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/hardware_offload_system/hardware_system.runs/lidar_arm_control_robot_arm_control_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lidar_arm_control_robot_arm_control_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lidar_arm_control_robot_arm_control_0_1.tcl
