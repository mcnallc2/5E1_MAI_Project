...
HD_PWD='/home/cmcnally/Repos/mai_project/Vivado/us_arm_control/us_arm_control.runs/us_arm_control_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log us_arm_control_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source us_arm_control_xbar_0.tcl
