...
HD_PWD='/home/cmcnally/Repos/robotic_arm_control_system_analysis/vivado/SW_based_control/us_arm_control_system/us_arm_control_system.runs/us_arm_module_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
