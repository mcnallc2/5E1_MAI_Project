...
HD_PWD='/home/cmcnally/Repos/mai_project/Vivado/pwm_servo_control/pwm_servo_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_servo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_servo_wrapper.tcl -notrace
