...
proc create_root_design { parentCell } {
  ...
  set PWM_CLK [ create_bd_port -dir I -type clk PWM_CLK ]
  ...
  set_property -dict [ list \
   CONFIG.PWM_COUNTER_MAX {2000000} \
 ] $robot_arm_control_0
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins robot_arm_control_0/S00_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs robot_arm_control_0/S00_AXI/S00_AXI_reg] SEG_robot_arm_control_0_S00_AXI_reg
