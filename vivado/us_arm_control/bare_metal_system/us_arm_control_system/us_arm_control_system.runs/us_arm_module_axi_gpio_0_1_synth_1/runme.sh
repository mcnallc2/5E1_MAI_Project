...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/us_arm_control/bare_metal_system/us_arm_control_system/us_arm_control_system.runs/us_arm_module_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log us_arm_module_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source us_arm_module_axi_gpio_0_1.tcl
