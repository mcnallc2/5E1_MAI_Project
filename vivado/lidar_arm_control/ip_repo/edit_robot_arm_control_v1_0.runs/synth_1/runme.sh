...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/ip_repo/edit_robot_arm_control_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log robot_arm_control_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source robot_arm_control_v1_0.tcl
