...
HD_PWD='/home/cmcnally/Repos/mai_project/Vivado/ultrasonic_sensors/ultrasonic_sensors.runs/ultrasonic_unit_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic_unit_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultrasonic_unit_rst_ps7_0_100M_0.tcl
