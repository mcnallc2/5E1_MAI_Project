...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/us_arm_control/freertos_system/us_arm_control_system/us_arm_control_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log us_arm_control_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source us_arm_control_system_wrapper.tcl -notrace
