...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/lidar_arm_control/hardware_offload_system_2/hardware_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lidar_arm_control_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lidar_arm_control_wrapper.tcl
