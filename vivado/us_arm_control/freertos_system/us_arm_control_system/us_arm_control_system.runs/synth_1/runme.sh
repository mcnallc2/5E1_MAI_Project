...
HD_PWD='/home/cmcnally/Repos/robotic-arm-control-system-analysis/vivado/us_arm_control/freertos_system/us_arm_control_system/us_arm_control_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log us_arm_control_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source us_arm_control_system_wrapper.tcl
