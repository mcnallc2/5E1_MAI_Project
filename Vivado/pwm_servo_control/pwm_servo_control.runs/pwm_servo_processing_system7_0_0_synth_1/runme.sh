...
HD_PWD='/home/cmcnally/Repos/mai_project/Vivado/pwm_servo_control/pwm_servo_control.runs/pwm_servo_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_servo_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_servo_processing_system7_0_0.tcl
